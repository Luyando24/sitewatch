    ...
    <>
      ...
      <div className="px-4 py-5 border-b border-gray-100 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <img src="/photos/sitewatch360-logo-thick.svg" alt="SiteWatch 360 Logo" className="w-10 h-10" />
          <div>
        ...
        <header className="bg-white border-b border-gray-100 px-4 md:px-6 py-3 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 sm:hidden">
              <img src="/photos/sitewatch360-logo-thick.svg" alt="SiteWatch 360 Logo" className="w-7 h-7" />
